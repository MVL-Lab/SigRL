...
def get_metadata(dataset_name):
    if dataset_name == 'pascal':
        meta = {
            'num_classes': 20,
            'path_to_dataset': '/u/vul-d1/scratch/xxing/SPML/data/pascal',
            'path_to_images': '/u/vul-d1/scratch/xxing/SPML/data/pascal/VOCdevkit/VOC2012/JPEGImages'
        }
    elif dataset_name == 'coco':
        meta = {
            'num_classes': 80,
            'path_to_dataset': '/u/vul-d1/scratch/xxing/SPML/data/coco',
            'path_to_images': '/u/vul-d1/scratch/xxing/SPML/data/coco'
        }
    else:
